<?php
    ...
    $req = $mysqli->query("UPDATE joueur2 SET nbrePions=0 WHERE idCase=6");
    ...
    if($point > 0)
    {
        ...
        if($point <= 0)
        {
            ...
            for($j=$pf; $j>=1; $j--)
            {
                $req = $mysqli->query("SELECT * FROM joueur1 WHERE idCase=$j");
                ...
                if($continue == 1)
                {
                    ...
                    $up2 = $mysqli->query("UPDATE joueur1 SET nbrePions=0 WHERE idCase=$j");
                }
            }   
        }
