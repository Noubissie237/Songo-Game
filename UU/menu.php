<?php
    ...
    $res7 = $mysqli->query("UPDATE personne SET nom='en attente du joueur 1' WHERE id=1");
    $res8 = $mysqli->query("UPDATE personne SET nom='en attente du joueur 2' WHERE id=2");